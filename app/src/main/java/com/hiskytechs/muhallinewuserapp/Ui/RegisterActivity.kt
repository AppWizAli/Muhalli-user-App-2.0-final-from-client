...
class RegisterActivity : AppCompatActivity() {
    ...
    private fun requestOtp() {
        ...
        if (buyerName.isBlank() || phone.length < 8 || city.isBlank()) {
            Toast.makeText(this, getString(R.string.buyer_registration_required), Toast.LENGTH_SHORT).show()
            return
        }
